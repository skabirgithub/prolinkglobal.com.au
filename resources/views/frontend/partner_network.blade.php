...
@section('title') Partner Network | {{setting('website_name')}} @endsection
@section('content')
@include('includes.banner',['programName'=>'Partner Network'])
<!-- WHO WE ARE -->
<section class="padding-top-70 padding-bottom-70">
    <div class="container">
        <div class="who-we">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="font-normal">{{setting('website_name')}}: Partner Network</h3>
