...
@section('title') Legal Entity | {{setting('website_name')}} @endsection
@section('content')
@include('includes.banner',['programName'=>'Legal Entity'])
<!-- WHO WE ARE -->
<section class="padding-top-70 padding-bottom-70">
    <div class="container">
        <div class="who-we">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="font-normal">{{setting('website_name')}}: Legal Entity</h3>
                    <h6>Legal Entity</h6>
